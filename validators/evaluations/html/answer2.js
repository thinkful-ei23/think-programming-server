...
module.exports = (htmlString, res, userId) => {  
  return Promise.all([evaluateElement(htmlString, 'script', 'src="jquery-3.3.1.min.js"')])
    .then(() => {
      UserStats.findOne({ userId }, function(err, userStats) {
        ...
        userStats.htmlCorrectPercentage = userStats.htmlTotalCorrect/userStats.htmlTotalAnswered * 100; 
