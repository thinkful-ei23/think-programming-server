...
describe('Think Programming API - GameRoom Endpoint', function () {
      ...
      it('should get a question when given a `jsQuestions` as question and an index within questions', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('num', 'title', 'question', 'total');
      ...
      it('should run the HTML test on the string being sent', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error', 'message');
            expect(res.body.error).to.eql(false);
            expect(res.body.message).to.eql('Correct! Challenge Completed! +100 Total Points, +100 HTML Points!');
          });
      });
      ...
      it('should return error true and message `Answer incorrect` when sending answer to question 2 (index 1) missing the `jquery-3.3.1.min.js` in src attr', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error','message');
            expect(res.body.error).to.eql(true);
            expect(res.body.message).to.eql('Incorrect! Challenge not Completed! -25 Total Points, -25 HTML Points!');
          });
      });
      ...
      it('should run successful test on the string being sent', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error', 'message');
            expect(res.body.error).to.eql(false);
            expect(res.body.message).to.eql('Correct! Challenge Completed! +100 Total Points, +100 CSS Points!');
          });
      });
      it('should return error when css answer only contains open  `/*` and not `*/`', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error', 'message');
            expect(res.body.error).to.eql(true);
            expect(res.body.message).to.eql('Incorrect! Challenge not Completed! -25 Total Points, -25 CSS Points!');
          });
      });
      it('should return error when css answer only contains open  `*/` and not `/*`', function () {
        const answer = 'and thats it */';
  ...
  describe('/api/gameRoom/answers/dsaQuestions/:num', function () {
    ...
    describe('POST dsaQuestion 1', function () {
      //"title": "Constant Time",
      //"question": "What is the constant time complexity in terms of Big-O notation?"
      it('should run successful test on and return status 200 on correct answer', function () {
        const answer = 'O(1)';
        const index = 0;
        let res;
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error', 'message');
            expect(res.body.error).to.eql(false);
            expect(res.body.message).to.eql('Correct! Challenge Completed! +100 Total Points, +100 DSA Points!');
          });
      });
      it('should run successful test on and return status 200 on correct answer that has extra spaces', function () {
        const answer = 'O ( 1 ) ';
        const index = 0;
        let res;
        return chai
      ...
      it('should return incorrect res when dsa answer is incorrect', function () {
        const answer = 'bad answer';
        const index = 0;
        let res;
        return chai
          .request(app)
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('error', 'message');
            expect(res.body.error).to.eql(true);
            expect(res.body.message).to.eql('Incorrect! Challenge not Completed! -25 Total Points, -25 DSA Points!');
          });
      });
    });  
    /*======DSA Question 2======*/
    describe('POST dsaQuestion 2', function () {
      //"title": "Bubble Sort",
      //"question": "What is the average time complexity of Bubble sort? (Options: O(1), O(n), O(n^2), O(log n))"
      it('should run successful test on and return status 200 on correct answer `question 2` index 1', function () {
        const answer = 'O(n^2)';
        let index = 1;
        let res;
        return chai
      ...
      it('should return incorrect res when dsa answer is incorrect to question 2 (index 1)', function () {
        const answer = 'incorrect answer';
        let index = 1;
        let res;
        return chai
    ...
    /*======DSA Question 3======*/
    describe('POST dsaQuestion 3', function () {
      //"title": "Quick Sort",
      //"question": "What is the average time complexity of Quick sort? (Options: O(1), O(n), O(n^2), O(n log(n))"
      it('should successfully return `error: false` when sending correct answer to question 3 (index 2)', function () {
        const answer = 'O(n log(n))';
        let index = 2;
        let res;
        return chai
          .request(app)
      ...
      it('should successfully trim answer return `error: false` when sending correct answer with extra spaces to question 3 (index 2)', function () {
        const answer = ' O ( n log ( n ) ) ';
        let index = 2;
        let res;
        return chai
      ...
      it('should return incorrect res when dsa answer is incorrect to question 3 (index 2)', function () {
        const answer = 'incorrect answer';
        let index = 2;
        let res;
        return chai
    ...
    /*======DSA Question 4======*/
    describe('POST dsaQuestion 4', function () {
      //"title": "Determine the Big O",
      //"question": "You are in a room with 15 puppies to find a playmate for your puppy who is of the same breed. You start with the first puppy to check if he is a samoyed. He was not, so you move on to the next puppy, and the next, and the next until you find a samoyed or until there is no more puppies to check."
      it('should successfully return `error: false` when sending correct answer to question 4 (index 3)', function () {
        const answer = 'O(n)';
        let index = 3;
        let res;
        return chai
      ...
      it('should successfully trim answer return `error: false` when sending correct answer with extra spaces to question 4 (index 3)', function () {
        const answer = ' O ( n ) ';
        let index = 3;
        let res;
        return chai
      ...
      it('should be able to extract correct answer despite having these characters `()- to question 4 (index 3)', function () {
        const answer = ' O ( n ) ()-()-';
        let index = 3;
        let res;
        return chai
      ...
      it('should return incorrect res when dsa answer is incorrect to question 4 (index 3)', function () {
        const answer = 'incorrect answer';
        let index = 3;
        let res;
        return chai
    ...
    /*======DSA Question 5======*/
    describe('POST dsaQuestion 5', function () {
      //"title": "Big O",
      //"question": "Big O measures algorithm speed in terms of... (Options: Space, Memory, Seconds, Growth of the number of operations)"
      it('should successfully return `error: false` when sending correct answer to question 5 (index 4)', function () {
        const answer = 'Growth of the number of operations';
        let index = 4;
        let res;
        return chai
          .request(app)
      ...
      it('should be case insensitive and successfully return `error: false` when sending correct answer to question 5 (index 4)', function () {
        const answer = 'GroWth Of the number oF OPERATIONS';
        let index = 4;
        let res;
        return chai
      ...
      it('should be space insensitive and successfully return `error: false` when sending correct answer as one continuous string to question 5 (index 4)', function () {
        const answer = 'growthofthenumberofoperations';
        let index = 4;
        let res;
        return chai
          .request(app)
      ...
      it('should return incorrect res when dsa answer is incorrect to question 5 (index 4)', function () {
        const answer = 'incorrect answer';
        let index = 4;
        let res;
        return chai
      ...
      it('Should return 200 status when sending existing room and `correct` verdict', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res).to.have.status(200);
            expect(res.body).to.be.an('object');
            expect(res.body).to.have.all.keys('room', 'verdict', 'message');
            expect(res.body.room).to.equal('jsQuestions');
            expect(res.body.verdict).to.equal('correct');
            expect(res.body.message).to.equal('Your review was correct! +25 Total Points, +25 Javascript Points!');
          });
      });
      it('Should return 200 status when sending existing room and `incorrect` verdict', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.have.all.keys('room', 'verdict', 'message');
            expect(res.body.room).to.equal('jsQuestions');
            expect(res.body.verdict).to.equal('incorrect');
            expect(res.body.message).to.equal('Your review was incorrect! -25 Total Points, -25 Javascript Points!');
          });
      });
    });
      ...
      it('Should return 200 status when sending existing room and `correct` verdict', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.be.an('object');
            expect(res.body).to.have.all.keys('room', 'verdict', 'message');
            expect(res.body.room).to.equal('htmlQuestions');
            expect(res.body.verdict).to.equal('correct');
            expect(res.body.message).to.equal('Your review was correct! +25 Total Points, +25 HTML Points!');
          });
      });
      it('Should return 200 status when sending existing room and `incorrect` verdict', function () {
        const answer = 'incorrect';
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body.room).to.equal('htmlQuestions');
            expect(res.body.verdict).to.equal('incorrect');
            expect(res.body.message).to.equal('Your review was incorrect! -25 Total Points, -25 HTML Points!');
          });
      });
    });
      ...
      it('Should return 200 status when sending existing room and `correct` verdict', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.be.an('object');
            expect(res.body).to.have.all.keys('room', 'verdict', 'message');
            expect(res.body.room).to.equal('cssQuestions');
            expect(res.body.verdict).to.equal('correct');
            expect(res.body.message).to.equal('Your review was correct! +25 Total Points, +25 CSS Points!');
          });
      });
      it('Should return 200 status when sending existing room and `incorrect` verdict', function () {
        const answer = 'incorrect';
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body.room).to.equal('cssQuestions');
            expect(res.body.verdict).to.equal('incorrect');
            expect(res.body.message).to.equal('Your review was incorrect! -25 Total Points, -25 CSS Points!');
          });
      });
    });
      ...
      it('Should return 200 status when sending existing room and `correct` verdict', function () {
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body).to.be.an('object');
            expect(res.body).to.have.all.keys('room', 'verdict', 'message');
            expect(res.body.room).to.equal('dsaQuestions');
            expect(res.body.verdict).to.equal('correct');
            expect(res.body.message).to.equal('Your review was correct! +25 Total Points, +25 DSA Points!');
          });
      });
      it('Should return 200 status when sending existing room and `incorrect` verdict', function () {
        const answer = 'incorrect';
        ...
        return chai
          ...
          .then(_res => {
            ...
            expect(res.body.room).to.equal('dsaQuestions');
            expect(res.body.verdict).to.equal('incorrect');
            expect(res.body.message).to.equal('Your review was incorrect! -25 Total Points, -25 DSA Points!');
          });
      });
    });
  });
